...
export const MASTER_DATA: Record<string, MasterRecord[]> = {
  ...
  testLocations: [
    { id: 'tloc-1', name: 'Mumbai Test Center 1 (Andheri)', code: 'TC-MUM-1', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-2', name: 'Mumbai Test Center 2 (BKC)', code: 'TC-MUM-2', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-3', name: 'Pune Assessment Hub (Hinjawadi)', code: 'TC-PUN-1', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-4', name: 'Pune Assessment Hub (Kharadi)', code: 'TC-PUN-2', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-5', name: 'Bengaluru Tech Park (Whitefield)', code: 'TC-BLR-1', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-6', name: 'Bengaluru Tech Park (Electronic City)', code: 'TC-BLR-2', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-7', name: 'Hyderabad Cyberabad Center', code: 'TC-HYD', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-8', name: 'Delhi NCR Hub (Noida)', code: 'TC-DEL-1', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-9', name: 'Delhi NCR Hub (Gurugram)', code: 'TC-DEL-2', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-10', name: 'Chennai OMR Assessment Hub', code: 'TC-CHE', status: 'Active', updatedAt: '2026-07-10' },
    { id: 'tloc-11', name: 'Online Remote Proctored (Home)', code: 'TC-ONL', status: 'Active', updatedAt: '2026-07-10' },
  ],
  departments: [
