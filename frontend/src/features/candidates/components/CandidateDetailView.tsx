...
/**
 * STEP Enterprise Candidate Workspace
 *
 * Reuses WorkspaceHeader primitive & 5 Secondary Tabs:
 * Overview, Assessment, Interviews, Documents, Activity
 */
export const CandidateDetailView: React.FC<CandidateDetailViewProps> = ({ candidateId = 'cand-1' }) => {
