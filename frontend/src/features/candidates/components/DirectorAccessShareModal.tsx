    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="dialog-card rounded-[var(--radius-xl)] p-5 sm:p-6 max-w-xl w-full shadow-[var(--shadow-xl)] flex flex-col gap-4 relative overflow-hidden bg-[var(--surface-1)] border border-[var(--border-default)]"
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-[var(--border-soft)] pb-3">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-cyan-500/10 text-cyan-400 flex items-center justify-center font-bold border border-cyan-500/30 shrink-0">
                <Icon name="shield-check" size="sm" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-base font-extrabold text-[var(--text-primary)] font-heading">
                    Director Access Gateway
                  </h3>
                ...
                <p className="text-xs text-[var(--text-secondary)]">
                  Generate secure one-time gateway link for executive evaluation
                </p>
              </div>
            </div>
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-1.5 rounded-lg text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-hover)] cursor-pointer transition-colors"
            >
              <Icon name="x" size="sm" />
            </button>
          </div>
