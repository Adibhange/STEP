...
export const MasterTable: React.FC<MasterTableProps> = ({
  ...
  // Modal form states (Recruiter enters Name & Status; Code is generated automatically)
  ...
  const handleSaveAdd = (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    // Auto-generate unique short code from record name
    const autoGeneratedCode = generateUniqueCode(formName, data);
  ...
  const handleSaveEdit = (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    // Preserve existing code if name unchanged, or regenerate unique code if name changed
    const autoCode =
          ...
          >
            ...
            <form onSubmit={handleSaveAdd} className="flex flex-col gap-4">
              <div>
                ...
                />
                <span className="text-[10.5px] text-[var(--text-tertiary)] mt-1 block font-mono">
                  Short code will be auto-generated & verified unique (e.g. {exampleName} → {exampleCode}).
                </span>
              </div>
              <div>
          ...
          >
            ...
            <form onSubmit={handleSaveEdit} className="flex flex-col gap-4">
              <div>
                ...
                />
                <span className="text-[10.5px] text-[var(--text-tertiary)] mt-1 block font-mono">
                  Current Code: <strong className="text-[var(--accent-indigo)]">{editingRecord.code || '—'}</strong>
                </span>
              </div>
              <div>
                <label className="text-[11.5px] font-bold text-[var(--text-secondary)] uppercase block mb-1">Status</label>
