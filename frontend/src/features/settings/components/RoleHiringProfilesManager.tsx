  ...
  return (
    ...
    >
      ...
      <EnterpriseModal
        ...
        title={editingTemplate?.id ? 'Edit Assessment Template' : 'Create Assessment Template'}
            ...
            <div className="space-y-2 border-t border-[var(--border-default)] pt-3">
              ...
              <div className="space-y-2">
                {(editingTemplate.sectionRules || []).map((rule, idx) => (
                  <div key={idx} className="p-3 rounded-xl bg-[var(--surface-2)] border border-[var(--border-default)] space-y-2">
