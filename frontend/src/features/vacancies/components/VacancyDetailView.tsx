...
/**
 * STEP Enterprise Vacancy Detail View — Primary Hiring Workspace
 */
export const VacancyDetailView: React.FC<VacancyDetailViewProps> = ({ vacancy }) => {
