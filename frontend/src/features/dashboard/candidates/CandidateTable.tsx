				...
				return (
					<td
						...
						<button
							...
							className='inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10.5px] font-bold border whitespace-nowrap font-sans shadow-xs max-w-full hover:scale-105 active:scale-95 transition-all duration-150 cursor-pointer'
