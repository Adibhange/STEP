	...
	reducers: {
		setCredentials: (
			...
			if (typeof window !== "undefined") {
				...
				if (refreshToken)
					localStorage.setItem("step_refresh_token", refreshToken);
				...
				if (user.employeeCode)
					localStorage.setItem("step_emp_code", user.employeeCode);
...
export const { setCredentials, logout, resetLogoutState, syncFromStorage } =
	authSlice.actions;
